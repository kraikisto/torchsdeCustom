...
class ForwardSDE(BaseSDE):
    ...
    def __init__(self, sde, fast_dg_ga_jvp_column_sum=False):
        ...
        self.p_prod = getattr(sde, 'p_prod', self.p_prod_default)
        self.prod = {
    ...
    def h_prod_default(self, t, y, v):
        return self.prod(self.h(t, y), v)
    
    ########################################
    #                p_prod                #
    ########################################

    def p_prod_default(self, t, y, v):
        return self.prod(self.p(t, y), v)
